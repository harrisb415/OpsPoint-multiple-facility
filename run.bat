...
del "%_ticker%" 2>nul
start /b powershell -NoProfile -Command "& { $s=Get-Date; $f='%_ticker%'; while (-not (Test-Path $f)) { $e=(Get-Date)-$s; [Console]::Title='OpsPoint v2.6.1   Up: '+$e.ToString('hh\:mm\:ss'); Start-Sleep 1 } }"
