...
export default function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-10 bg-gradient-to-br from-slate-200 via-slate-100 to-primary-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-900">
