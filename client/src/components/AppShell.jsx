...
function Header({ onGoTab }) {
  ...
  function fileWellnessChecks() {
    ...
    const thCols = checkCols.map(col => `<th class="chk-th">${esc(col.time)}<div style="font-size:8px;font-weight:400;color:#A8C0E8;margin-top:2px;">${esc(col.monitor)}</div></th>`).join('')
